...
public class ColorSegment {
    ...
    public static void main(String[] args) {
        ...
        BufferedImage image = UtilImageIO.loadImage("corn2.png");

		// Let the user select a color
		printClickedColor(image);                
		// Display pre-selected colors
		showSelectedColorOutSideRim("Dirt",image,6.2f,0.37f);
		showSelectedColorInSideRim("Green",image,1.5f,0.65f);
    }
}
